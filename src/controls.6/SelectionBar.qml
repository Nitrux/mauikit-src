          ...
          Maui.PopupPage
          {
               ...
               onOpened:
               {
                    ...
                    for(var i in control.actions)
                         m_actions.push(control.actions[i])
                    m_actions.push(_closeAction)
                    _actions = m_actions
               }
     ...
     Maui.ToolBar
     {
          ...
          leftContent: Loader
          {
               ...
               sourceComponent: ToolButton
               {
                    ...
                    Maui.Theme.backgroundColor: Qt.tint(control.Maui.Theme.textColor, Qt.rgba(control.Maui.Theme.backgroundColor.r, control.Maui.Theme.backgroundColor.g, control.Maui.Theme.backgroundColor.b, 0.9))
                    ...
                    MouseArea
                    {
                         ...
                         onClicked:
                         {
                              var dialog = _listContainerComponent.createObject(control)
                              dialog.open()
